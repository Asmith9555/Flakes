{ pkgs, config, ... }:
{
    ...
    keymap = {
      default_view = {
        keymap = [
          { 
            keys = ["L"];
            command = "cursor_move_page_middle";
          }
          { 
            keys = ["M"];
            command = "cursor_move_page_end";
          }
          { 
            keys = ["["];
          ...
          { 
            keys = ["y" "l"]; 
            command = "symlink_files --relative=false";
          }
          { 
            keys = ["y" "L"]; 
            command = "symlink_files --relative=true";
          }
          { 
            keys = ["delete"]; 
  ...
  home = {
    ...
    file = {
      ...
      ".config/joshuto/preview_file.sh".source = ./config/previewfile.sh;
    };
  };
}
